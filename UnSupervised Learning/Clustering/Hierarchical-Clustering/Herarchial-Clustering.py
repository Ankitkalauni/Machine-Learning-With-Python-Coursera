...
#random dataset for clustering
X1, y1 = make_blobs(n_samples=50, centers=[[4,4], [-2, -1], [1, 1], [10,4]], cluster_std=0.9)

plt.scatter(X1[:, 0], X1[:, 1], marker='o') #Ploting the dataset
...
#reading and importing df
df = pd.read_csv(r'cars_clus.csv')
...
p = df.groupby(['cluster_','type'])['cluster_'].count()
